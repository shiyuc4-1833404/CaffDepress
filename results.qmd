...
library(MASS)
mosaic(~maritalStatus + depressLevel, 
       labeling=vcd::labeling_border(rot_labels = c(0, 30), 
                                  labeling_args = list(cex = 1)),
       main="Mosaic Plot of Gender and Depression Level",
       data=merged_info, direction=c("v","h"),
       spacing = spacing_dimequal(c(.4, 0)),
       highlighting = "depressLevel",
       highlighting_fill = c("lightblue", "pink", "#cc9966","salmon","steelblue"))
```
